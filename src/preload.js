...
contextBridge.exposeInMainWorld("brightside", {
  ...
  getScreenplays: () => ipcRenderer.invoke("screenplay:get"),
  importScreenplay: () => ipcRenderer.invoke("screenplay:import"),
  removeScreenplay: id => ipcRenderer.invoke("screenplay:remove", id),
  openScreenplayFolder: () => ipcRenderer.invoke("screenplay:open-folder"),
