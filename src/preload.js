...
contextBridge.exposeInMainWorld("brightside", {
  ...
  getTeam: () => ipcRenderer.invoke("team:get"),
  saveTeamProfile: name => ipcRenderer.invoke("team:profile", name),
  sendTeamMessage: text => ipcRenderer.invoke("team:send", text),
  attachTeamFiles: () => ipcRenderer.invoke("team:attach"),
  openTeamAttachments: () => ipcRenderer.invoke("team:open-attachments"),
